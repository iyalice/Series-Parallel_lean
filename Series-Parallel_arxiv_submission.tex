...
Then there exists a smallest admissible parameter
...
\]
The required admissible-parameter theory for this ODE is a specialization of
the singular first-order theory of Engui\c{c}a, Gavioli, and
Sanchez~\cite[Proposition~2.3 and Theorem~3.7]{EnguicaGavioliSanchez2013};
the additional endpoint regularity needed for the discrete barriers is
established in Appendix~\ref{app:ode}.
...
means that the ratio of their absolute value is bounded above and below by positive constants in
...
\eqref{eq:main-W-bvp}. This existence result is a special case of
\cite[Proposition~2]{EnguicaGavioliSanchez2013}. An alternative proof of
Proposition~\ref{prop:Cstar-halfline} is given in Appendix~\ref{app:ode}.
\begin{proposition}
...
\end{aligned}
\end{equation}
Recall $\lambda>0$ is \emph{admissible} if \eqref{eqn:ode-W} admits a solution
$W\in C([0,1])\cap C^1((0,1))$.
...
\end{proposition}
\begin{remark}
  The upper bound $\frac{\sqrt3}{2}$ above is an elementary bound used only to prove the finiteness of $\lambda_*$. In fact, \cite[Proposition~2]{EnguicaGavioliSanchez2013} gives $\lambda_*\le 2^{-1/3}$. The lower bound here is new.
\end{remark}
...
Finally, we derive the asymptotics of $\gamma_R$ by utilizing Theorem \ref{thm:first-moment-logarithmic-rates}.
...
This appendix gives analysis of an ODE classification that is a special case of known $p$-Laplacian travelling-wave theory. Setting $Y(u)=W(u)^3$ transforms the equation into
\[
Y'=\frac32\{2\lambda Y^{1/3}-2u(1-u)\},
\]
which is the case $p=3$, $q=3/2$, $c=2\lambda$, and $f(u)=2u(1-u)$ of Enguiça, Gavioli, and Sanchez~\cite[Proposition~2 and Theorem~3.3]{EnguicaGavioliSanchez2013}. Equivalently, it is the phase-plane equation for the $3$-Laplacian Fisher--KPP travelling waves studied by Audrito and Vázquez~\cite[Theorem~2.1 and Section~3]{AudritoVazquez2017}. 
...
$u=0$. The existence of admissible parameter and the uniqueness of solutions in our work are similar to the analysis in \cite{EnguicaGavioliSanchez2013}, while the endpoint asymptotics in our work are stronger than \cite{EnguicaGavioliSanchez2013}.
...
Applying \cite[Proposition 3.(a)(e)(f)]{EnguicaGavioliSanchez2013}, we have the following lemma.
\begin{lemma}
...
%The proposition below are specialization of Engui\c{c}a, Gavioli, and Sanchez \cite{EnguicaGavioliSanchez2013}.
Now we are ready to give our own proof of Proposition~\ref{prop:Cstar-halfline}. In our own proof, we get a sharper lower bound for $\lambda_*$ than \cite{EnguicaGavioliSanchez2013}.
% \begin{proposition}
% \label{prop:Cstar-halfline}
...
% \end{proposition}
% \begin{remark}
%   The upper bound $\frac{\sqrt3}{2}$ above is an elementary bound used only to prove non-emptiness of $\mathcal{A}$. It is not the best bound available from the travelling-wave literature. Indeed, Proposition~2 of Engui\c{c}a, Gavioli, and Sanchez gives $\lambda_*\le 2^{-1/3}$.
% \end{remark}
...
$y_{\lambda_*}(1)=0$, so $\lambda_*\in\mathcal A$.  Combining this with the
upward-closed property proves $\mathcal A=[\lambda_*,\infty)$ and gives the stated upper
bound for $\lambda_*$.
\end{proof}
...
\cite{EnguicaGavioliSanchez2013} and the travelling-wave classification and phase-plane analysis \cite{AudritoVazquez2017}. For supercritical asymptotic, our result is stronger than \cite{EnguicaGavioliSanchez2013}.
